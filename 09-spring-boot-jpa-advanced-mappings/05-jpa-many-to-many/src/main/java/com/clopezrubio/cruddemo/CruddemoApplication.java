...
import com.clopezrubio.cruddemo.entity.*;
...
public class CruddemoApplication {
    ...
    private void findStudentAndCourses(AppDAO appDAO) {
        ...
        System.out.println("Student with given ID: " +  tempStudent);
        System.out.println("Associated courses: " + tempStudent.getCourses());
    }
    ...
    private void createCourseAndStudents(AppDAO appDAO) {
        ...
        // create the students
        Student tempStudent1 = new Student("John", "Doe", "john@blablabla.com");
        Student tempStudent2 = new Student("Mary", "Public", "mary@blablabla.com");
    ...
    private void retrieveCourseAndReviews(AppDAO appDAO) {
        ...
        // print the course
        System.out.println("Retrieved Course with ID: " + theId);
    ...
    private void createCourseAndReviews(AppDAO appDAO) {
        ...
        tempCourse.addReview(new Review("Nice One! Cool course"));
